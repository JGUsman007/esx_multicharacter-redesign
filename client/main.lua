...
if ESX.GetConfig().Multichar then
	...
	AddEventHandler('esx_multicharacter:SetupCharacters', function()
	    ...
	    PointCamAtCoord(cam, Config.Spawn.x, Config.Spawn.y, Config.Spawn.z + .5)
		StartLoop()
	...
	RegisterNUICallback('selectcharacter', function(data, cb)
		...
		local value = data
		TriggerServerEvent('esx_multicharacter:CharacterChosen', value, false)
	end)
